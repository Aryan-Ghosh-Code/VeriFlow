...
_**The platform integrates Web3 smart contracts, decentralized identity, and modern web technologies to provide a secure, scalable, and user‑friendly experience**_.

⚠️ **Core Problem**
Today’s rental ecosystem suffers from fundamental inefficiencies:
...
💡 Our Solution: 
 Dynamic collateral based on on‑chain user trust score 📊 
